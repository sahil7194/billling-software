...
<table class="table table-hover">
   ...
   <tbody id="gst_table_data">
     <?php 	
     	$sql_for_data="SELECT `invoice_id`,  `amount`, `mode` FROM `purches_payment` WHERE MONTH(`create_at`)='$date' ORDER BY `create_at` DESC;";
     	...
     	while ($row_for_data=mysqli_fetch_array($run_for_data)) 
     	{
	         ...
	         <td>
	            <?php  purches_get_invoice_number($row_for_data['invoice_id']); ?>
	         </td>	         
	         <td>
